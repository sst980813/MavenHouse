...
<div class="header">
    <div style="margin: 0 45% 0 45%;padding-top:5%;text-align:center;">
        <div style="height:16%;width:90%;background:black;text-align:center;">
            <h3 style="font-family: Menlo;color:white;padding-top:5%;"><strong>Housing</strong></h3>
        </div>
        <h4 style="margin-top:16%;margin-left:-10%;">
            ...
            <br/>
            <label>Nanjing Institute of Technology</label>
            <label>Shao Shuting</label>
        </h4>
    </div>
</div>
...
<div class="container">
    <div id="content">
        <h2 class="text-nowrap" style="color: #393D49;text-align:center;padding-top:5%;font-family: Menlo">租房通后台管理系统</h2>
        ...
        <form action="<%=basePath%>/admin/register.do" id="registerform" method="post" class="layui-form" hidden="hidden" style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                ...
                <div style="text-align:center;color: #009688;background-color: #01AAED;width:48%;margin-left:34%;">
                    <input type="button" class="layui-btn layui-btn-lg" style="background: none;" value="Sign up" onclick="validate()"/>
                </div>
            </div>
        </form>
