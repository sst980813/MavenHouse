...
<body>
 <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4" style="width: 100%; height:100%;">
  ...
  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" >类型</th>
  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"  >描述</th>
  ...
  <tbody>
            ...
            <tr>  
                ...
                <td>${c.trajectoryType}</td>
                <td>${c.explaindetail}</td>
                <td>${c.createTime}</td>
            </tr>
        </c:forEach>
   </tbody>
